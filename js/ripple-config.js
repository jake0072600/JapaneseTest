...
/*  var circle = document.getElementById('js-ripple'),
  ...
  function rippleAnimation(event,svgId, timing) {
  ...
  return {
    init: function(target,svgId,timing) {
      var button = document.getElementById(target);

      button.addEventListener('click', function(event) {
        rippleAnimation.call(this, event,svgId, timing);
      });
    }
  };
})();

//ripplyScott.init('js-ripple-btn', 1.75);